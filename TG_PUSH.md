...
![TG_PUSH1](https://github.com/ww69mm/jc/blob/main/icon/TG_PUSH1.png)

Ⅱ.利用[BotFather](https://t.me/BotFather)创建一个属于自己的通知机器人，按照下图中的1、2、3步骤拿到token，格式形如```10xxx4:AAFcqxxxxgER5uw```。填入```TG_BOT_TOKEN```<br>

![TG_PUSH2](https://github.com/ww69mm/jc/blob/main/icon/TG_PUSH2.png)<br>
...
![TG_PUSH3](https://github.com/ww69mm/jc/blob/main/icon/TG_PUSH3.png)
